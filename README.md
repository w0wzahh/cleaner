...
**Installer (recommended):** grab `Cleaner-Setup-2.9.4.exe` from the
...
**Portable zip:** grab `cleaner-v2.9.4-windows-x64.zip` instead, unzip
...
See [CHANGELOG.md](CHANGELOG.md). Current version is **2.9.4**.
